...
![alt_text](https://github.com/puneeth019/F.R.I.E.N.D.S/blob/master/plots/%23Num_Dial_vs_season.png "Number of Dialogues vs. Season")
   ...
   **Season 6** has the *highest* #dialogues (10,897) out of all Ten seasons. And season 5 *(10,738)*, season 6 & season 7*(10,798)* have almost same #number of dialogues. Maybe the writers tended to create more contect toward the middle of the series.
...
Even from this plot it can be concluded that Phoebe spoke the least.
