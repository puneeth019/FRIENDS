...
The idea is to analyze and understand the contribution of all characters in [F.R.I.E.N.D.S TV series (1994-2004) (https://en.wikipedia.org/wiki/Friends) in detail.
...
Data is scraped from episode **transcipts** which are in the form of `html` files. These transcripts can be downloaded from here or here http://www.friendstranscripts.tk/.
